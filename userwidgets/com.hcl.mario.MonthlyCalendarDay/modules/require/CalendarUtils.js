define(function () {
  return {
    isHoliday({day, month, year}){
      ...
      //Kenia
      if((day === 1 && month === 1) || (day === 1 && month === 5) || 
         (day === 1 && month === 6) || (day === 10 && month === 10) || 
         (day === 20 && month === 10) || (day === 12 && month === 12) || 
      ...
      //Kenia
      if((day === 29 && month === 3 && year === 2024) || (day === 31 && month === 3 && year === 2024) ||
         (day === 1 && month === 4 && year === 2024) || (day === 10 && month === 4 && year === 2024) ||
         (day === 17 && month === 6 && year === 2024) ||
         
         (day === 18 && month === 4 && year === 2025) || (day === 21 && month === 4 && year === 2025) ||

  ...
  return {
          ...
          this.view.flxHoursContainer.onScrollEnd = () => {
            if(this.initHoursDone){
              ...
              if(this.view.flxHoursContainer.contentOffset.y !== selectedHours * ROW_HEIGHT){
                this.view.flxHoursContainer.contentOffset = {x: 0, y: selectedHours * ROW_HEIGHT};
              }
          ...
          this.view.flxMinutesContainer.onScrollEnd = () => {
            if(this.initMinutesDone){
              ...
              if(this.view.flxMinutesContainer.contentOffset.y !== selectedMinutes * ROW_HEIGHT){
                this.view.flxMinutesContainer.contentOffset = {x: 0, y: selectedMinutes * ROW_HEIGHT};
              }
    ...
    show(selectedTime, widgetId){
      ...
      voltmx.timer.schedule('myTimer', () => {
        ...
        this.view.flxHoursContainer.contentOffset = {x: 0, y: `${parseInt(selectedTimeValues[0]) * ROW_HEIGHT}dp`};
        this.view.flxMinutesContainer.contentOffset = {x: 0, y: `${parseInt(selectedTimeValues[1]) * ROW_HEIGHT}dp`};
      }, 0.1, false);
    },

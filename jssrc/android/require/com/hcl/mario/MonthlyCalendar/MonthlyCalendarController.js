define("com/hcl/mario/MonthlyCalendar/userMonthlyCalendarController", function() {
            const SECONDS = 86400;
            ...
            return {
                ...
                selectDay(mcd) {
                    ...
                    if (currentMcd !== null) {
                        ...
                        currentMcd.skinDay = (currentMcd.month !== this.view.monthSelector.month) ? SKIN_DAY_OTHER_MONTH : (calendarUtils.isHoliday({
                            day: currentMcd.day,
                            month: currentMcd.month,
                            year: currentMcd.year
...
define("com/hcl/mario/MonthlyCalendar/MonthlyCalendarControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("com/hcl/mario/MonthlyCalendar/MonthlyCalendarController", ["com/hcl/mario/MonthlyCalendar/userMonthlyCalendarController", "com/hcl/mario/MonthlyCalendar/MonthlyCalendarControllerActions"], function() {
    var controller = require("com/hcl/mario/MonthlyCalendar/userMonthlyCalendarController");
    var actions = require("com/hcl/mario/MonthlyCalendar/MonthlyCalendarControllerActions");

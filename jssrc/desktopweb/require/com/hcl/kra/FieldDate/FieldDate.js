define(function() {
    return function(controller) {
        var FieldDate = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "appName": "KRADemo"
        }, controller.args[0], "FieldDate"), extendConfig({
            "paddingInPixel": false
        }, controller.args[1], "FieldDate"), extendConfig({}, controller.args[2], "FieldDate"));
        FieldDate.setDefaultUnit(voltmx.flex.DP);
        ...
        var lblWidget = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "lblWidget"), extendConfig({}, controller.args[2], "lblWidget"));
        ...
        FieldDate.add(lblLabel, flxWidget);
        return FieldDate;
    }
})
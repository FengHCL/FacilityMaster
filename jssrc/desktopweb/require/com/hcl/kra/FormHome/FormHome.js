define(function() {
    return function(controller) {
        ...
        var iconType = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "iconType"), extendConfig({}, controller.args[2], "iconType"));
        var resourceName = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "resourceName"), extendConfig({}, controller.args[2], "resourceName"));
        var iconSelector = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "iconSelector"), extendConfig({}, controller.args[2], "iconSelector"));

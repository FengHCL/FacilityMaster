define(function() {
    return function(controller) {
        ...
        var lblUpdate = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "lblUpdate"), extendConfig({}, controller.args[2], "lblUpdate"));
        ...
        var lblAllocate = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "lblAllocate"), extendConfig({}, controller.args[2], "lblAllocate"));

define(function() {
    return function(controller) {
        ...
        var lblWelcome = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "lblWelcome"), extendConfig({
            "textCopyable": false,
            "wrapping": constants.WIDGET_TEXT_WORD_WRAP
        }, controller.args[2], "lblWelcome"));
        ...
        var btnFacebookLogin = new voltmx.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnFacebookLogin"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnFacebookLogin"));
        ...
        var lblSep2 = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "lblSep2"), extendConfig({
            "textCopyable": false,
            "wrapping": constants.WIDGET_TEXT_WORD_WRAP
        }, controller.args[2], "lblSep2"));
        ...
        var lblSep1 = new voltmx.ui.Label(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "lblSep1"), extendConfig({
            "textCopyable": false,
            "wrapping": constants.WIDGET_TEXT_WORD_WRAP
        }, controller.args[2], "lblSep1"));
        ...
        var btnSignUp = new voltmx.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSignUp"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnSignUp"));
